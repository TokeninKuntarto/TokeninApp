...
class CryptoTokenPage extends StatelessWidget with NavigationStates {
  @override
          ...
          child: Column(
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Text(
                    "    Koleksi Crypto Tokens",
                    style: TextStyle(color: Color(0xFFFF9800), fontWeight: FontWeight.bold, fontSize: 20),
                  ),
                  Text(
                    "Menu",
